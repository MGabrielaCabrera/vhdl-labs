...
There is one VHDL testbench file per module: `axi_lite_slave_if`,
`control_fsm` and `register_bank`.

### sv/
SystemVerilog structured testbench to simulate main module
`top_level_wrapper`. It introduces interfaces, clocking blocks,
and class-based drivers/scoreboards for better reusability 
and scalability toward UVM.
