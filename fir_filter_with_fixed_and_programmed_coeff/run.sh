...
echo "Elaborating three_arranged_adders testbench"
ghdl -e -fsynopsys --workdir=build -o build/config_rtl_three_arranged_adders config_rtl_three_arranged_adders

echo "Running config_rtl_three_arranged_adders testbench. Waveforms saved to waves/waves_config_rtl_three_arranged_adders.fst"
build/config_rtl_three_arranged_adders.exe --fst=waves/waves_config_rtl_three_arranged_adders.fst

echo "Opening waveform viewer for config_rtl_three_arranged_adders (only if the fst file exists)"
[ -f waves/waves_config_rtl_three_arranged_adders.fst ] && gtkwave waves/waves_config_rtl_three_arranged_adders.fst &
